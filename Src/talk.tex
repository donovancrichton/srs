...
\begin{frame}[fragile]
  ...
  %code for prg goes here, correct by construction
  \begin{minted}
  \end{minted}
\end{frame}
...
\begin{frame}[fragile]
  ...
  %discuss how in the case of mod, we can have the time parameter
  %expressed as a function of the input
\end{frame}

\begin{frame}[fragile]
  \frametitle{Elaboration and Compilation of a small correct core}
  %diagram on how a small correct core can be both elaborated and compiled
